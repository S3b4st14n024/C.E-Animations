document.addEventListener("DOMContentLoaded", function(event) {
    ...
    listadoProductos.forEach(element => {
        divProductos.innerHTML = divProductos.innerHTML + '<div class="card"><div class="card-body"><h5 class="card-title">Nombre del producto: ' + element["nombre_producto"] + '</h5></div></div>';
    });
    return false;
});
